...
if (!html.includes('apple-mobile-web-app-capable')) {
  ...
  <style>
    ...
    /* 스플래시: position:fixed + 4방향 0 → 뷰포트 완전 고정.
       inset 단축어/svh 단위 미지원 브라우저 대비 개별 속성으로 명시. */
    [data-testid="splash-container"]{position:fixed!important;top:0!important;left:0!important;right:0!important;bottom:0!important;width:100%!important;height:100%!important}
  </style>`;

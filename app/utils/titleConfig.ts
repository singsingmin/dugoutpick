...
const FIXED_TITLES: Record<string, TitleDisplay> = {
  'title.rookie_watcher':   { label: '신입 관전러', description: '예측 리그 첫 참여' },
  'title.first_prediction': { label: '첫 예측 완료', description: '예측 리그 첫 예측 제출' },
  'title.first_hit':        { label: '첫 적중 완료', description: '예측 첫 적중' },
  'title.streak3':          { label: '3연속 적중러', description: '3연속 적중 달성' },
  'title.streak5':          { label: '5연속 적중러', description: '5연속 적중 달성' },
  'title.honey_detective':  { label: '꿀잼 탐정', description: '누적 적중 10회 달성' },
  'title.veteran30':        { label: '야구각 감별사', description: '누적 유효 참여 30회 달성' },
};

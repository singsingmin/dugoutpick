      ...
      {game.honjam && (
        <>
          <View style={styles.honjamRow}>
            ...
            <ScoreSkinRenderer score={game.honjam.score} variant="detail" teamColor={teamColor(game.home.code)} />
            <PixelText color={colors.gold} style={styles.spark}>✦</PixelText>
          </View>
...
const styles = StyleSheet.create({
  ...
  num: { width: 20, height: 20, alignItems: 'center', justifyContent: 'center', borderRadius: 2 },
  pointText: { flex: 1 },
  factorRow: { flexDirection: 'row', alignItems: 'center', marginVertical: 3, gap: spacing.sm },
  factorLabel: { width: 78 },
  barTrack: { flex: 1, height: 10, backgroundColor: colors.surfaceAlt, borderRadius: 3, overflow: 'hidden' },

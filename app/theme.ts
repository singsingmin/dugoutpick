...
export const colors = {
  bg: '#F3E9CE',        // 크림 배경
  surface: 'rgba(255,252,245,0.88)', // 카드(따뜻한 화이트, 반투명 — 배경 이미지 위에서 이미지 비쳐 보임)
  surfaceAlt: 'rgba(234,223,191,0.88)', // 보조/선택 강조 (반투명 — 배경 이미지 비쳐 보임)
  ...
  textDim: '#3A3530',   // 보조 텍스트 (다크 브라운 — 메인보다 살짝 연하게 위계 유지)
